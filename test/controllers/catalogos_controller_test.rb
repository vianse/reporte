...
class CatalogosControllerTest < ActionController::TestCase
  ...
  test "should create catalogo" do
    assert_difference('Catalogo.count') do
      post :create, catalogo: { app_id: @catalogo.app_id, año: @catalogo.año, mes: @catalogo.mes, objetivo_obligado: @catalogo.objetivo_obligado, objetivo_real: @catalogo.objetivo_real, user_id: @catalogo.user_id }
    end
  ...
  test "should update catalogo" do
    patch :update, id: @catalogo, catalogo: { app_id: @catalogo.app_id, año: @catalogo.año, mes: @catalogo.mes, objetivo_obligado: @catalogo.objetivo_obligado, objetivo_real: @catalogo.objetivo_real, user_id: @catalogo.user_id }
    assert_redirected_to catalogo_path(assigns(:catalogo))
  end
